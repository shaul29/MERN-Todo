...
export const TODO_LIST_MY_REQUEST = 'TODO_LIST_MY_REQUEST'
export const TODO_LIST_MY_SUCCESS = 'TODO_LIST_MY_SUCCESS'
export const TODO_LIST_MY_FAIL = 'TODO_LIST_MY_FAIL'
export const TODO_LIST_MY_RESET = 'TODO_LIST_MY_RESET'
